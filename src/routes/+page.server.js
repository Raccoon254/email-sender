  ...
  <body style="font-family: Arial, sans-serif; color: #333; margin: 0; padding: 20px; background-color: #f7f7f7;">
    <div style="max-width: 600px; margin: 0 auto; background: #ffffff; border: 1px solid #ddd; border-radius: 10px; overflow: hidden;">
      ...
      <div style="padding: 20px;">
        ...
        <div style="display: flex; justify-content: space-around; align-items: center; margin: 20px 0; height: 40px; margin-bottom: 10px;">
        ...
        <!-- Compensation Note -->
        <p style="font-size: 16px; margin-top: 20px; line-height: 1.6;">As a token of appreciation, you will be <strong>financially compensated</strong> for your feedback. To claim your payment, please reach out to the app developer using the link below.</p>
        
        <!-- WhatsApp Contact Button -->
        <div style="text-align: center; margin: 20px 0;">
          <a href="https://wa.me/254758481320" style="display: inline-block; background-color: ; color: black; padding: 10px 25px; border-radius: 100px; text-decoration: none; font-size: 18px;
